...
async function openCamera(side){
  ...
  modal.innerHTML=`<div class="cc-camera-card"><h3>${side==='Obverse'?'Obverse / Face':'Reverse'} Picture</h3><div class="cc-camera-frame"><video autoplay playsinline></video><img data-review hidden alt="Picture preview"><canvas hidden></canvas></div><div class="actions" data-live><button type="button" class="primary" data-snap>Take Picture</button><button type="button" class="secondary compact" data-close>Cancel / Close</button></div><div class="actions" data-confirm hidden><button type="button" class="primary" data-use>Use This Picture</button><button type="button" class="secondary compact" data-retake>Retake</button><button type="button" class="secondary compact" data-cancel>Cancel / Close</button></div></div>`;
...
.cc-camera-confirm-modal .actions{background:#fff!important;padding:8px 0 2px!important;margin-top:6px!important;display:flex!important;gap:8px!important;align-items:center!important;flex-wrap:nowrap!important}
.cc-camera-confirm-modal .actions .primary{flex:1 1 auto!important;min-width:0!important}
.cc-camera-confirm-modal .actions .compact{flex:0 0 auto!important;min-width:auto!important;width:auto!important;padding-left:14px!important;padding-right:14px!important}
@media(max-width:480px){.cc-camera-confirm-modal .cc-camera-frame{height:48dvh!important}.cc-camera-confirm-modal .cc-camera-card{padding:10px!important}.cc-camera-confirm-modal .actions button{font-size:14px!important;padding:10px 7px!important}.cc-camera-confirm-modal .actions .compact{padding-left:9px!important;padding-right:9px!important}}
