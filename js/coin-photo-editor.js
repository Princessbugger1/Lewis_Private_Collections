/* Coin Chime — lightweight crop/inspect editor for any coin photo.
 * Obverse / Face, Reverse, and Edge all use the same editor. No extra stored thumbnail.
 */
(function () {
  'use strict';
