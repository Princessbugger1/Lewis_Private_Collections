(()=>{
  function installBackButton(){
    ...
    button.style.cssText='float:right;margin-top:-34px;background:#e5e7eb;color:#111827;padding:7px 10px;border-radius:9px;font-weight:650;cursor:pointer;border:0';
